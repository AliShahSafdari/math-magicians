...
**math-magicians** is a setup of React, design of calculator, add the logic of the calcolator, and fetch Data from API.
...
```sh
 cd my-folder
 git clone git@github.com:AliShahSafdari/mathomagicians.git
```
### Install
